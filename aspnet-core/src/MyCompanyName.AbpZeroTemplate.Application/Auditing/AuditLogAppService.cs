...
namespace MyCompanyName.AbpZeroTemplate.Auditing
{
    ...
    public class AuditLogAppService : AbpZeroTemplateAppServiceBase, IAuditLogAppService
    {
        ...
        public List<NameValueDto> GetEntityHistoryObjectTypes()
        {
            ...
            {
                entityHistoryObjectTypes.Add(new NameValueDto(L("MyCompanyName.AbpZeroTemplate.MultiTenancy.Tenant"), "MyCompanyName.AbpZeroTemplate.MultiTenancy.Tenant"));
            }

            entityHistoryObjectTypes.Add(new NameValueDto(L("MyCompanyName.AbpZeroTemplate.MultiTenancy.Role"), "MyCompanyName.AbpZeroTemplate.MultiTenancy.Role"));
